...
// Los estados se acumulan (se van sumando)
...
export default function MultipleStates() {
  ...
  const updateState = (key = '', value) => {
    ...
    return setState(prev => ({ ...prev, [key]: value }));   // los [] son necesarios para que que el valor sea variable, si no tomará como valor la palabra key.
  };
